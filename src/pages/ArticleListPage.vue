  ...
  <div>
    ...
    <section class="section section-article-list px-2">
      <div class="container mx-auto">
        <div class="mt-6 mx-auto" v-bind:key="article.id" v-for="article in state.articles">
          <div class="px-6 py-6 bg-white rounded-lg shadow-md">
            ...
            <div class="mt-2 flex items-center">
              <span class="font-light text-gray-600 mx-14">{{ article.regDate }}</span>
              <div>
                <router-link :to="'detail?id=' + article.id" class="flex items-center mx-14">
                  <img
              ...
              <router-link
                ...
                class="text-2xl text-gray-700 font-bold hover:underline mx-14"
